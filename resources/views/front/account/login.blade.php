            ...
            <div class="row">
                ...
                <div class="col-lg-5">
                    <form method="POST" class="auth_form">
                        @csrf
                        <h4 class="h2">Daxil ol</h4>
                        <div class="input_list">
                            <div class="mb-15">
                                <input type="text" name="email" placeholder="Emailini daxil et ">
                            </div>
                            <div class="mb-15 pass_input">
                        ...
                        <div class="auth_btn">
                            <button type="submit" class="btn_blue">Daxil ol</button>
                            <a href="{{ route('register') }}" class="btn_outline_blue">
                                Qeydiyyat
                            </a>
                        </div>
                        <p class="">
