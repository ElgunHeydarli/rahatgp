...
@section('content')
    <div class="message_area profile_container">
        <div>
            <div class="page_title">
                <h1 class="h1_bold color_blue">
                  Şəxsi hesab məlumatları
                </h1>
                <h2 class="h2">
                  Məlumatlarınızın düzgün olduğundan əmin olun
                </h2>
            </div>
                ...
                <form method="POST" class="auth_form">
                    ...
                    <div class="input_list">
                        ...
                        <div class="pass_input mb-15">
                            <input type="text" name="old_password" class="password_input" placeholder="Old Password">
                            <span class="close_eye active-eye">
                        ...
                        <div class="pass_input mb-15">
                            <input type="text" name="new_password" class="password_input" placeholder="New Password">
                            <span class="close_eye active-eye">
                                <svg width="17" height="15" viewBox="0 0 17 15" fill="none"
                                    xmlns="http://www.w3.org/2000/svg">
                                    <path
                    ...
                    <div class="auth_btn">
                        <button class="btn_blue">Yadda saxla</button>
                    </div>
                </form>
            </div>
        </div>
