    ...
    <section class="products_section">
        <div class="container">
            <div class="products_title">
                <h1 class="h1_bold">
                   Sizin üçün nə tapdıq?
                </h1>
                <h2 class="h2">Ən yaxşı nəticələr </h2>
                                ...
                                <div class="product_top">
                                    ...
                                    <div class="favorite_box">
                                        <a href="/add-to-cart/{{ $product->id }}"
                                            class="basket_box {{ array_key_exists($product->id, $basket) ? 'active' : '' }} add-to-cart">
                                        ...
                                        <a class="favorite_box_item {{ array_key_exists($product->id, $favorite) ? 'active' : '' }} add-to-favorite"
                                            href="/add-to-favorite/{{ $product->id }}">
...
@push('js')
    ...
    <script>
        let basketBtn = $('.favorite_box .add-to-cart');
        ...
        let favoriteBtn = $('.favorite_box .add-to-favorite');
